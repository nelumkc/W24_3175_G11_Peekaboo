...
import com.example.w24_3175_g11_peekaboo.interfaces.NotificationDao;
...
@Database(entities = {User.class, Parent.class, Child.class, Entry.class, Attendance.class, Notification.class}, version = 1, exportSchema = false)
